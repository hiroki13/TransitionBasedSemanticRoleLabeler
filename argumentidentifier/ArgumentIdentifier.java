...
public class ArgumentIdentifier {
    ...
    public void eval(final ArrayList<Sentence> testsentencelist, final ArrayList<Sentence> evalsentencelist)
    {
        ...
        final float p = correct/p_total;
        final float r = correct/r_total;
    ...
    public void confusionMatrix(final ArrayList<Sentence> testsentencelist, final ArrayList<Sentence> evalsentencelist)
    {
    ...
    public void showAccuracy(final String label, final float[] value1, final float[] value2, final float[] value3)
    {
    ...
    public int[] extractFeatures(final Sentence sentence, final int prd, final int arg)
    {
        return feature_extracter.extractAIFeature(sentence, prd, arg);        
    }
    
    public int sign(final float score)
    {
        if (score >= 0) return 1;
        return -1;
    }

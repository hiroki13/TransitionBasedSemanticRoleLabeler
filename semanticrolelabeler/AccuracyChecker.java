...
public class AccuracyChecker {
    ...
    public void testAI(final ArrayList<Sentence> testsentencelist,
                        final ArrayList<Sentence> evalsentencelist,
    ...
    public void testPD(final ArrayList<Sentence> testsentencelist,
                        final ArrayList<Sentence> evalsentencelist,                        
    ...
    public void outputAC(final ArrayList<Sentence> sentencelist, final String fn) throws IOException
    {
        PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(fn + "-output.txt")));
    ...
    public void outputAI(final ArrayList<Sentence> sentencelist, final String fn) throws IOException
    {
        PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(fn + "-ai-output.txt")));
    ...
    public String setArgument(final Token t)
    {
        String text = "";
    ...
    public String setArgument(final Sentence sentence, final int target_arg_id)
    {
        String text = "";
    ...
    public String setPred(final Token t)
    {
    ...
    private HashMap<String, MultiClassPerceptron> getAvePerceptrons(final PredicateDisambiguator pd)
    {
    ...
    private float[][] averagingWeights(final Classifier c)
    {
    ...
    private float[] averagingWeights(final Perceptron p)
    {
